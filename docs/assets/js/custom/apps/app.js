(function ($) {
  ...
  var dtModule = {
    ...
    calculateHeight: function () {
      ...
      console.log('bodyVerticalPadding: ', bodyVerticalPadding);
      ...
      if (this.appModule.hasClass('dt-module--chat')) {
        ...
        this.appModuleSidebar.find('.dt-module__sidebar-content .dt-contacts__container').height(sc_height - tabHeaderHeight - bodyVerticalPadding);
      }
