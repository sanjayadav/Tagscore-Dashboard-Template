(function ($) {
    ...
    gradientGrowthRevenue.addColorStop(0, color('#06BC8D').alpha(0.9).rgbString());
    gradientGrowthRevenue.addColorStop(1, color('#05C9D0').alpha(0.9).rgbString());
    ...
    gradientGrowthTraffic.addColorStop(0, color('#61B1E4').alpha(0.9).rgbString());
    gradientGrowthTraffic.addColorStop(1, color('#867AE5').alpha(0.9).rgbString());
    ...
    new Chart(ctxLessRevenue, {
        ...
        data: {
            ...
            datasets: [{
                    ...
                    pointRadius: 0,
                    backgroundColor: color('#E81D27').alpha(0.9).rgbString(),
                    borderColor: 'transparent',
                    hoverBorderColor: 'transparent',
                    pointBorderWidth: 0,
                    pointHoverBorderWidth: 0,
    ...
    gradientTotalIncome.addColorStop(0.4, color('#ed8faa').alpha(0.9).rgbString());
    gradientTotalIncome.addColorStop(1, color('#6757de').alpha(0.9).rgbString());
    ...
    var gradientSupportQueries = ctxSupportQueries.createLinearGradient(0, 0, 180, 230);
    gradientSupportQueries.addColorStop(0.4, color('#23DFDC').alpha(0.9).rgbString());
    gradientSupportQueries.addColorStop(1, color('#63AEE4').alpha(0.9).rgbString());
    ...
    new Chart(ctxSupportQueries, {
        ...
        data: {
            ...
            datasets: [{
                    ...
                    backgroundColor: gradientSupportQueries,
                    hoverBackgroundColor: gradientSupportQueries,
                }]
        },
